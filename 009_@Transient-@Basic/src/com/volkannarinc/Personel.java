...
public class Personel implements Serializable {
	...
	@Basic	//alanýnnull deðer alýp almadýðýnýn kontrolünü saðlar.
	private String personelAdi;	//Bu alan mutlaka veritabanýnda olacak.
	
	@Transient	//Bir alanýn haritalanmasýný görmezden gelir.
	private String personelSoyadi;	//Veritabanýnda soyadý deðeri olmayacak.
