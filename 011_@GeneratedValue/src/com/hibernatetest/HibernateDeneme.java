...
public class HibernateDeneme {
	...
	public static void main(String[] args) {
		...
		personel2.setPersonelSoyadi("Keskin");
		personel2.setPersonelKayitTarihi(new Date());
		personel2.setPersonelAdresi("Serdivan/SAKARYA");
		...
		personel = (Personel) session.get(Personel.class, 2); //1 deðeri hangi id deðerine sahip personeli getrirttiðimizi belirtmek için kullanýlýr.
		System.out.println("ID DEÐERÝ : " + personel.getPersonelId());
		System.out.println("ADI SOYADI : " + personel.getPersonelAdi() + " " + personel.getPersonelSoyadi());
		System.out.println("KAYIT TARÝHÝ : " + personel.getPersonelKayitTarihi());
		System.out.println("ADRESÝ : " + personel.getPersonelAdresi());
