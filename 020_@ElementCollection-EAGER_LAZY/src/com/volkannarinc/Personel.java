...
public class Personel implements Serializable {
	 ...
	 * 
	 ...
	 SINIFADI_DÝPNOTUN KULLANILDIÐI NESNE.KOLEKSÝYON SINIFLARIYLA BERABER KULLANILIR.(HashSet,Collection)
	 	...
	 	BÝRBÝRÝ ÝLE ÝLÝÞKÝLÝ TABLOLAR ARASINDA KAYIT ÇEKME TÜRÜMÜZÜ BELÝRLERKEN ;
	 EÐER BÜTÜN KAYITLARI ÝSTÝYORSAK --> "EAGER"
	 HEPSÝNE GEREK YOKSA --> LAZY 	KULLANIRIZ.	VARSAYILAN OLARAK "EAGER"DIR.
	 BU SEÇÝMÝ "fetch" ÖZNÝTELÝÐÝ ÝLE SAPLARIZ.	
	*
	...
	*/
	@ElementCollection(fetch = FetchType.LAZY)  // VEYA EAGER
